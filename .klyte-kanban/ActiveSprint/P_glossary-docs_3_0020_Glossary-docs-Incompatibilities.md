...
- [ ] Document subsection "External policy and model conflicts" in BelzontTLM/i18n/en-US/glossary.content.groups.incompatibilities.external.md (accurate, complete, aligned with current behavior)
