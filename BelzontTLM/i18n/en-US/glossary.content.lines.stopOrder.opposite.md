...
---
Select a stop on the XTM linear map to open **Stop Data**. When another stop on the route has the same parent station or building, use the circular-arrow button to focus and select that platform.
