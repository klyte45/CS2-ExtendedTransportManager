...
---
XTM uses **passenger line** for services carrying people and **cargo route** for services carrying resources. Internally, many controls and systems use the shorter word “line” for both.
...
Vehicle Model Groups must match both the transport type and whether the route carries passengers or cargo. Cargo rail groups can additionally pair engines with compatible carriages.

Fare Groups are for passenger lines in the current interface. Cargo routes do not appear in the Fare Group line picker.
