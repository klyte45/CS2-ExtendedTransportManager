...
Without a custom name, the game generates a localized name for the transport type. XTM supplies the display identifier to that naming pattern when one is set; otherwise it supplies the internal route number.

Names appear on listing cards and reports, and as tooltips for route shields in connection and group-management views.
