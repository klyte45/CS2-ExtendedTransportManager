...
---
## Modes shown in the listing

The XTM listing covers passenger **bus, tram, subway, train, ship, ferry, and airplane lines**, plus **train, ship, and airplane cargo routes**.

Passenger and cargo versions of the same transport mode are separate groups. For example, passenger trains and cargo trains have different filter buttons, icons, labels, and listing sections.
